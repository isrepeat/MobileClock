...
```powershell
MobileClock.XamlPreviewer/XamlPreviewer.WPF/bin/Debug/net8.0-windows/XamlPreviewer.exe
```
...
```powershell
dotnet run --project MobileClock.AndroidHost/Tests/XamlPreviewer/NativeTransitions.csproj -- .
```