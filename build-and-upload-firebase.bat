...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0bump-version.ps1"
if errorlevel 1 (
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0build-android.ps1" -UploadFirebase
