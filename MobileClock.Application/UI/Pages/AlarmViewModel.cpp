...
namespace mobileclock::ui {
    ...
    AlarmViewModel::AlarmViewModel(std::string id, Alarm alarm, bool isEnabled)
    ...
    AlarmViewModel::AlarmViewModel(const Alarm& alarm)
    ...
    const mobileclock::ui::Alarm& AlarmViewModel::Settings() const {
        return this->alarm;
    }
