...
[NavigationTransition.xaml](Example/Page/NavigationTransition.xaml).
...
Примеры: [PageTransitions.xaml](Example/Page/PageTransitions.xaml), [NavigationTransition.xaml](Example/Page/NavigationTransition.xaml) и [CustomPageAnimation.xaml](Example/Page/CustomPageAnimation.xaml).
...
Пример разметки: [ButtonGlow.xaml](Example/Button/ButtonGlow.xaml).
...
См. полный пример [NavigationTransition.xaml](Example/Page/NavigationTransition.xaml).
